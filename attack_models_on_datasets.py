...
from attack_method_self_defined import Adam_FGSM, Adam_FGSM_incomplete
...
def generate_attack_method(attack_name, model, epsilon, Iterations, Momentum):
    ...
    elif attack_name == 'Adam_FGSM_incomplete':
        atk = Adam_FGSM_incomplete(model, eps=epsilon, steps=Iterations, decay=Momentum)
    else:
        atk = None
    return atk
